...
using GowerDome2025.DeviceAccess;
...
namespace GowerDome2025
{
    public class Program
    {
        ...
        internal const string DriverID = "GowerDome2025.Alpaca";
        ...
        internal const int DefaultPort = 11111;

        //Fill these out
        internal const string Manufacturer = "Paul Kirk";

        internal const string ServerName = "Gower Dome Server";
        ...
        public static void Main(string[] args)
        {
            ...
            ASCOM.Alpaca.DeviceManager.LoadDome( 0,  new DeviceAccess.GowerDome(),     "GowerDome2025",     ServerSettings.GetDeviceUniqueId("Dome", 0));
